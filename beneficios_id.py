...
def get_beneficios_id_requisicao(offset):
    try:
        url = geral.url + \
            f"monitoramento/beneficio?tamanhoPagina=5&offset={offset}&apenasAbertas=false&apenasModificadasNosUltimos30Dias=false&dataInteracaoInicial=2024-03-17&dataInteracaoFinal=2024-03-23&colunasSelecionadas=id&colunasSelecionadas=atividade"

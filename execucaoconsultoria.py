        ...
        for i, tarefa in enumerate(data):
            if tarefa:
                ...
                if tarefasprecedentes:
                    for tarefapre in tarefasprecedentes:
                ...
                supervisores = tarefa['campos'].get('EquipeGeral', {}).get('valor')  # Nota: campo duplicado
                supervisor = []
                if supervisores:
                ...
                papeis = tarefa['campos'].get('papeisTrabalho', {}).get('valor')
                papeistrabalho = []
                if papeis:
                    for papers in papeis:
...
def salvar_dados(resultado_array):
    try:
        ...
        for tarefa in resultado_array:
            ...
            insert_query = (f"""INSERT INTO execucao_consultoria_auxiliar (id, situacao, estado, atividade, titulo, idtarefaassociada, titulotarefaassociada,

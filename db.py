...
def delete_datas(banco):
   ...
   #lista_tabelas = ['atividade_continuada', 'auditorias', 'monitoramento', 'projeto_geral', 'tarefas_id', 'beneficios_id', 'tarefas', 'beneficios', 'interacoes']
    ...
    lista_tabelas = ['achados_auditoria_auxiliar',  'analise_auditoria_auxiliar', 'analise_preliminar_auxiliar',  'apuracao_preliminar_auxiliar',
                   'atividade_continuada_auxiliar', 'auditorias_auxiliar', 'auto_avaliacao_iacm_auxiliar', 'comunicacao_auditoria_auxiliar',
                   'escopo_auditoria_auxiliar', 'execucao_consultoria_auxiliar', 'interacoes_auxiliar', 'item_analise_tce_auxiliar', 'item_trabalho_atividade_auxiliar',
                   'item_trabalho_projeto_auxiliar', 'kpa_iacm_auxiliar', 'matriz_planejamento_auxiliar', 'minuta_posicionamento_auxiliar',
                   'monitoramento_auxiliar',  'planejamento_consultoria_auxiliar', 'projeto_geral_auxiliar', 'relatorio_final_auxiliar',
                   'relatorio_preliminar_auxiliar', 'resultados_consultoria_auxiliar', 'termo_compromisso_consultoria_auxiliar',
                    'tarefas_auxiliar', 'tarefas_id_auxiliar', 'beneficios_auxiliar', 'beneficios_id_auxiliar']

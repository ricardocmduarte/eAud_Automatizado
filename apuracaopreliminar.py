    ...
    try:
        ...
        for i, tarefa in enumerate(data):
            if tarefa:
                ...
                anexo = tarefa['campos']['anexosGerais']['valor']
                anexosgerais = []
                if anexo:
                    for i, file in enumerate(anexo):
                ...
                obss = tarefa['campos']['observadores']['valor']
...
def salvar_dados(resultado_array):
    try:
        ...
        for tarefa in resultado_array:
            ...
            insert_query = (f"""INSERT INTO apuracao_preliminar_teste (id, situacao, estado, atividade, titulo, idtarefaassociada, titulotarefaassociada,

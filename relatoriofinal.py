...
def get_relatorio_final(ids_relatorio):
...
def salvar_dados(lista_relatorio_final):
    try:
        banco = db.db_connection
        cur = banco.cursor()

        lista_relatorio_final = db.current_datetime_query(
            lista_relatorio_final)

        for tarefa in lista_relatorio_final:
            lista = [
                (tarefa['id'],
                 tarefa['situacao'],
                 tarefa['estado'],

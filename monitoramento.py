        ...
        for i, tarefa in enumerate(data):
            if tarefa:
                ...
                if categoriamonitoramento:
                    ...
                    categoriasmonitoramento = join_data(
                        categoriasmonitoramento)
                ...
                if ultimoposicionamento:
                    ...
                    tipoultimoposicionamento = join_data(
                        tipoultimoposicionamento)
...
def salvar_dados(resultado_array):
    try:
        ...
        for tarefa in resultado_array:
            ...
            insert_query = (f"""INSERT INTO monitoramento_teste (id, situacao, estado, atividade, titulo, idtarefaassociada, titulotarefaassociada,

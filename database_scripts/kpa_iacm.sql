...
(
    ...
    atividaeskpa character varying(5000) COLLATE pg_catalog."default",
    ...
    produtokpa character varying(5000) COLLATE pg_catalog."default",
    resultadoskpa character varying(5000) COLLATE pg_catalog."default",
    praticakpa character varying(5000) COLLATE pg_catalog."default",

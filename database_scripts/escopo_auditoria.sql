-- Table: public.escopo_auditoria

-- DROP TABLE IF EXISTS public.escopo_auditoria;

CREATE TABLE IF NOT EXISTS public.escopo_auditoria
(
    id integer NOT NULL,
    ...
    hiposetelegal character varying(5000) COLLATE pg_catalog."default",
    ...
    CONSTRAINT escopo_auditoria_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.escopo_auditoria
    OWNER to m1478769;

REVOKE ALL ON TABLE public.escopo_auditoria FROM x09972752;

GRANT SELECT ON TABLE public.escopo_auditoria TO m13365929;

GRANT ALL ON TABLE public.escopo_auditoria TO m1478769;

GRANT SELECT ON TABLE public.escopo_auditoria TO m7532203;

GRANT SELECT ON TABLE public.escopo_auditoria TO x09972752;

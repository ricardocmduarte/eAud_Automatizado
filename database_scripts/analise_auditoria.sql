...
(
    ...
    descteste character varying(5000) COLLATE pg_catalog."default",
    desccriterio character varying(5000) COLLATE pg_catalog."default",
    descinformacao character varying(5000) COLLATE pg_catalog."default",
    descfonte character varying(5000) COLLATE pg_catalog."default",
    desclimitacao character varying(5000) COLLATE pg_catalog."default",
    descachado character varying(5000) COLLATE pg_catalog."default",
    observacoes character varying(5000) COLLATE pg_catalog."default",
    descricaoescopo character varying(5000) COLLATE pg_catalog."default",
    responsavelitem character varying(5000) COLLATE pg_catalog."default",
    anexoescopo character varying(5000) COLLATE pg_catalog."default",
    anexoevidencia character varying(5000) COLLATE pg_catalog."default",
    autoranexoevidencia character varying(5000) COLLATE pg_catalog."default",

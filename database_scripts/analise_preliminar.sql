-- Table: public.analise_preliminar

-- DROP TABLE IF EXISTS public.analise_preliminar;

CREATE TABLE IF NOT EXISTS public.analise_preliminar
(
    id integer NOT NULL,
    ...
    CONSTRAINT analise_preliminar_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.analise_preliminar
    OWNER to m1478769;

REVOKE ALL ON TABLE public.analise_preliminar FROM x09972752;

GRANT SELECT ON TABLE public.analise_preliminar TO m13365929;

GRANT ALL ON TABLE public.analise_preliminar TO m1478769;

GRANT SELECT ON TABLE public.analise_preliminar TO m7532203;

GRANT SELECT ON TABLE public.analise_preliminar TO x09972752;

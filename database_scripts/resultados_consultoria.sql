-- Table: public.resultados_consultoria

-- DROP TABLE IF EXISTS public.resultados_consultoria;

CREATE TABLE IF NOT EXISTS public.resultados_consultoria
(
    id integer NOT NULL,
    ...
    idplanotrabalho integer,
    tituloplanotrabalho character varying(5000) COLLATE pg_catalog."default",
    idatividadeplanotrabalho integer,
    atividadeplanotrabalho character varying(5000) COLLATE pg_catalog."default",
    assuntoatividadeplanotrabalho character varying(5000) COLLATE pg_catalog."default",
    ...
    CONSTRAINT resultados_consultoria_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.resultados_consultoria
    OWNER to m1478769;

REVOKE ALL ON TABLE public.resultados_consultoria FROM x09972752;

GRANT SELECT ON TABLE public.resultados_consultoria TO m13365929;

GRANT ALL ON TABLE public.resultados_consultoria TO m1478769;

GRANT SELECT ON TABLE public.resultados_consultoria TO m7532203;

GRANT SELECT ON TABLE public.resultados_consultoria TO x09972752;

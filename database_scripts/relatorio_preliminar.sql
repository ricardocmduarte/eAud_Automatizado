-- Table: public.relatorio_preliminar

-- DROP TABLE IF EXISTS public.relatorio_preliminar;

CREATE TABLE IF NOT EXISTS public.relatorio_preliminar
(
    id integer NOT NULL,
    ...
    CONSTRAINT relatorio_preliminar_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.relatorio_preliminar
    OWNER to m1478769;

REVOKE ALL ON TABLE public.relatorio_preliminar FROM m7532203;

GRANT SELECT ON TABLE public.relatorio_preliminar TO m13365929;

GRANT ALL ON TABLE public.relatorio_preliminar TO m1478769;

GRANT SELECT ON TABLE public.relatorio_preliminar TO m7532203;

-- Table: public.execucao_consultoria

-- DROP TABLE IF EXISTS public.execucao_consultoria;

CREATE TABLE IF NOT EXISTS public.execucao_consultoria
(
    id integer NOT NULL,
    ...
    papeistrabalho character varying(5000) COLLATE pg_catalog."default",
    ...
    CONSTRAINT execucao_consultoria_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.execucao_consultoria
    OWNER to m1478769;

REVOKE ALL ON TABLE public.execucao_consultoria FROM x09972752;

GRANT SELECT ON TABLE public.execucao_consultoria TO m13365929;

GRANT ALL ON TABLE public.execucao_consultoria TO m1478769;

GRANT SELECT ON TABLE public.execucao_consultoria TO m7532203;

GRANT SELECT ON TABLE public.execucao_consultoria TO x09972752;

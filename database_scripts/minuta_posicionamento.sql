...
(
    ...
    recomendacaominuta character varying(10485760) COLLATE pg_catalog."default",
    detalhamentomonitoramento character varying(10485760) COLLATE pg_catalog."default",
